                                                ...
                                                <div class="uk-grid-margin uk-first-column">
                                                        <div class="uk-grid-small uk-flex-center uk-grid" uk-grid="">
                                                                <div class="uk-first-column">
                                                                        <a class="uk-button uk-button-default uk-button-small uk-text-left" uk-tooltip="title: Hello World; pos: top-left" href="settings.html"><span class="uk-margin-xsmall-right uk-icon uk-tila" uk-icon="server"></span></a>
                                                                </div>
                                                                <div>
                                                                        <a class="uk-button uk-button-default uk-button-small" href="<?php echo base_url().'/exit?url='.base_url(uri_string()); ?>" title="Log out">
