    ...
    <ul class="uk-switcher uk-margin">
        <li>
            ...
            <ul class="uk-pagination">
                <li>
                    <a href="#" uk-switcher-item="previous"><span class="uk-margin-small-right" uk-pagination-previous></span> Previous</a>
                </li>

                <li class="uk-margin-auto-left">
                    <a href="#" uk-switcher-item="next">Next <span class="uk-margin-small-left" uk-pagination-next></span></a>
                </li>
            </ul>
        </li>
        <li>
                                        ...
                                        <div class="uk-grid-small uk-child-width-1-1 uk-grid uk-grid-stack" uk-grid="">
                                                <section class="uk-first-column ">
                                                        <div class="uk-width-1-3 uk-width-1-4@s uk-width-1-2@m uk-margin-auto uk-visible-toggle uk-position-relative uk-border-circle uk-overflow-hidden uk-light">
                                                                <img class="uk-width-1-1" src="https://thispersondoesnotexist.com/image">
